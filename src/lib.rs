...
#[derive(Debug)]
pub struct Web3FactoryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl Web3FactoryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Web3Factory processing");
    
    let mut processor = Web3FactoryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = Web3FactoryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = Web3FactoryProcessor::new(false);
